  ...
  for(let i=0;i<props.data.length;i++){
    if(props.data[i].name==props.name){
      for(let j=0;j<props.data[i].marks.length;j++){
        ...
        c3_arr.push(connection[props.data[i].marks[j].mark.c3])
        c4_arr.push(connection[props.data[i].marks[j].mark.c4])
        c5_arr.push(connection[props.data[i].marks[j].mark.c5])
      }
    }
  }
  let set=[]
